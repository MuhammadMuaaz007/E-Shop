const styles = {
  ...
  button1:
    "w-40 h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer bg-gradient-to-r from-purple-800 to-blue-500 text-white font-semibold shadow-md hover:scale-105 hover:shadow-xl transition-transform duration-300",
  cart_button:
